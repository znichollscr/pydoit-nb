"""
Retrieve data notebook-based step definition
...
def _configure_notebooks(
    ...
    configured_notebooks = [
        ConfiguredNotebook(
            unconfigured_notebook=uc_nbs_dict[Path("020_retrieve-data")],
            configuration=(config_step.source,),
            dependencies=(),
            targets=(
                config_step.file_raw_data,
                config_step.file_clean_data,
            ),
            **common,
        ),
    ]
...
step = UnconfiguredNotebookBasedStep(
    ...
    unconfigured_notebooks=[
        UnconfiguredNotebook(
            notebook_path=Path("020_retrieve-data"),
            raw_notebook_ext=".py",
            summary="Retrieve data",
            doc="Retrieve data from a source",
        ),
    ],
